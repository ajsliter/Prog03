	...
	*/
    ...
    function list_records() {
        ...
        echo "
            ...
            <body>
                <a href='https://github.com/ajsliter/Prog03' target='_blank'>Github</a><br />
                <div class='container'>
                    <p class='row'>
                        <h3>$this->title" . "s" . "</h3>
                    </p>
		...
		<a href='img/Prog02%20UML%20Class%20Diagram.png' target='_blank'>UML Class Diagram (OLD)</a>
		<br>
		<a href='img/Prog03UMLDiag.png' target='_blank'>UML Class Diagram (Current)</a>
		<br>
                <a href='Prog02UserFlow.htm' target='_blank'>User Flow Diagram (OLD)</a>
		<br>
		<a href = 'login.htm' target='_blank'>User Flow Diagram (Current) </a>
